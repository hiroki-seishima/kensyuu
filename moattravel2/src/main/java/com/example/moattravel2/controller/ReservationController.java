package com.example.moattravel2.controller; //32-3

import java.time.LocalDate; //34-4で追加
...
import org.springframework.validation.BindingResult; //34-4で追加
import org.springframework.validation.FieldError; //34-4で追加
import org.springframework.validation.annotation.Validated; //34-4で追加
...
import com.example.moattravel2.form.ReservationInputForm; //34-4で追加
import com.example.moattravel2.form.ReservationRegisterForm; //34-4で追加
...
public class ReservationController {
    ...
    @GetMapping("/houses/{id}/reservations/input") // 34-4input
